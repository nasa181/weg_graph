...
# model = gensim.models.Doc2Vec(min_count=10,size=300,iter=30,alpha=0.05, min_alpha=0.05)
...
# f = open('result_k-mean_output_after_plot','w')
...
# num_of_no_froup = 21 # number of no_group
# n_neighbor = 78-21
